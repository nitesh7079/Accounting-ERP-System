    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md animate-fade-in border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Join Veneer ERP Platform Today</p>
        </div>
              ...
              <div>
                ...
                {error.includes('already exists') && (
                  <p className="text-sm mt-1">
                    This username or email is already registered. Try logging in or use different credentials.
                  </p>
                )}
              </div>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-gray-800 text-sm font-bold mb-2 tracking-wide">Username</label>
          ...
          <div>
            <label className="block text-gray-800 text-sm font-bold mb-2 tracking-wide">Confirm Password</label>
            <div className="relative">
              <input
                type="password"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full btn-gradient text-white py-4 px-6 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed transform transition-all duration-300 mt-6"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center border-t border-gray-200 pt-6">
          <p className="text-gray-600 text-sm">
            ...
            <Link to="/login" className="font-bold gradient-text hover:underline">
              Sign In
            </Link>
          </p>
